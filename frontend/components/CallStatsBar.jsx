  ...
  return (
    <div style={{ display: "flex", gap: 20, padding: "8px 16px", background: C.subtle, borderRadius: 8, border: `1px solid ${C.border}`, marginBottom: 16 }}>
      {[
        ...
        { label: "Est. cost", value: `£${stats.cost_estimate_gbp}` },
        { label: "Trial credit left", value: `~$${stats.trial_credit_remaining_estimate}`, color: stats.trial_credit_remaining_estimate < 5 ? C.dead : C.confirmed },
